...
import com.naztech.HumanIM.Human;
...
public class HumanTest {
	...
	private Map<Integer, Human> unSortedMap() {
		...
		un.put(0,new Human("Mahabub", 27, 17000.15f, LocalDate.of(1994, 12, 21)));
		un.put(3,new Human("mizan", 25, 25000.32f, LocalDate.of(1995, 03, 24)));
		un.put(2,new Human("Lipu", 22, 15000.35f, LocalDate.of(1996, 05, 01)));
		un.put(1,new Human("sajal", 20, 18000.12f, LocalDate.of(1997, 02, 01)));
	...
	private Map<Integer, Human> nameSortedMap() {
		...
		Mnam.put(0,new Human("Mahabub", 27, 17000.15f, LocalDate.of(1994, 12, 21)));
		Mnam.put(1,new Human("sajal", 20, 18000.12f, LocalDate.of(1997, 02, 01)));
		Mnam.put(2,new Human("Lipu", 22, 15000.35f, LocalDate.of(1996, 05, 01)));
		Mnam.put(3,new Human("mizan", 25, 25000.32f, LocalDate.of(1995, 03, 24)));
